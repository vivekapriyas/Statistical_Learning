...
```{r 5b1, echo=TRUE, eval=TRUE, fig.align="center"}
set.seed(1)
x1 = c(1, 2, 0, 4, 5, 6)
x2 = c(5, 4, 3, 1, 1, 2)
n = 6
...
```{r 5b2, echo=TRUE, eval=TRUE, fig.align="center"}
...
```{r 5b3, echo=TRUE, eval=TRUE, fig.align="center"}
for (i in 1:n){
...
```
For all the six combinations of linkages and distance measures, the tissues were clustered into two groups that coincide with whether the tissues came from a healthy patient or a diseased patient. From the dendrograms above, we see that all the methods are able to correctly cluster the two groups of  tissues from the patients. Hence, all the hierarchical clustering methods performed equally good and there is no hierarchical clustering method that stands out as the best. 
